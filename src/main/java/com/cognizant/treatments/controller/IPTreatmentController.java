...
public class IPTreatmentController {
	 ...
	 * microservice autowires the IPTreatmentService
	 */
	...
	/**
	 * { "id":1, "name":"John", "age":21, "ailment":"Arthritis",
	 * "treatmentPackageName":"Package 1" }
	 */

	/**
	 * Method-POST,
	 * http://localhost:9091/iptreatments/formulatetreatmenttimetable/7000
	 * 
	...
	public TreatmentPlan formulateTreatmentTimetable(@RequestHeader(name = "Authorization") String token,
			@RequestBody PatientDetail patientDetail, @PathVariable int cost) throws InvalidTokenException {
	 ...
	 * 
	 * to get the list of all the treatment plan available for patients only after
	...
	public List<TreatmentPlan> getAllOnGoingTreatments(@RequestHeader(name = "Authorization") String token)
			throws InvalidTokenException {
	...
	public PatientDetail getPatient(@RequestHeader(name = "Authorization") String token, @PathVariable long patientId)
			throws InvalidTokenException {
		...
		if (authResponse.isValid()) {
			...
			log.debug("Patient by id: " + patientId + " is being displayed successfully!");
			log.debug("======" + iptService.getPatient(patientId));
			}
	...
	public TreatmentPlan getAPlan(@RequestHeader(name = "Authorization") String token, @PathVariable int patientId)
			throws InvalidTokenException {
	...
	public void updatePlan(@RequestHeader(name = "Authorization") String token, @PathVariable long patientId)
			throws InvalidTokenException {
