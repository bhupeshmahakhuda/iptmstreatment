...
class IPTreatmentControllerTest {
	...
	public void testGetAllPatients() throws Exception {
		...
		MvcResult result = mockMvc.perform(get("/iptms/getallplans").header("Authorization", "Bearer Token"))
				.andReturn();
...
//		when(authClient.verifyToken("Bearer Token")).thenReturn(new AuthResponse("admin1", "admin1", true));
//		MvcResult result = mockMvc.perform(MockMvcRequestBuilders.post("/iptms/formulatetreatmenttimetable/15000")
//				.content(asJsonString(patient)).contentType(MediaType.APPLICATION_JSON_VALUE)
//				.accept(MediaType.APPLICATION_JSON_VALUE).header("Authorization", "Bearer Token")).andReturn();
//		String expected = "{\"id\":1,\"ptDetail\":{\"id\":1,\"name\":\"John\",\"age\":25,\"ailment\":\"Urology\",\"treatmentPackageName\":\"Package1\",\"treatmentCommencementDate\":\"2021-03-11\"},\"testDetails\":\"Test 1, Test 2\",\"packageName\":\"Package1\",\"specialist\":\"Dr. A.K Mishra\",\"cost\":15000.0,\"status\":\"In Progress\",\"treatmentCommencementDate\":\"2021-03-11\",\"treatmentEndDate\":\"2021-03-20\"}";
//		String actual = result.getResponse().getCharacterEncoding().toString();
//		String actual1 = result.getResponse().getContentAsByteArray().toString();
